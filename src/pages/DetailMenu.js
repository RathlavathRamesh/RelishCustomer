...
const DetaillMenu = () => {
  ...
  return (
    <div className="min-h-screen bg-cover bg-fixed"
      style={{ backgroundImage: "url('https://res.cloudinary.com/dnovcmruv/image/upload/v1716488314/Photo_Menu_2_fxyl91.png')" }}>
      <div className="w-full h-[100vh] flex justify-center items-end ">
        <div
          className={`w-[376px] bg-[#FEFEFF] text-black rounded-t-[30px] overflow-y-auto transition-all duration-500 ${isExpanded ? 'h-[80vh]' : 'h-[30vh]'}`}>
            ...
            <h1 className='text-[#09051C] font-montserrat text-[25px] mt-5 font-semibold leading-[25.72px] text-center '>Rainbow Sandwich Sugarless</h1>
            ...
            <p className='text-[#000000] first-letter:font-montserrat text-[12px] font-medium m-4 leading-[21.66px] text-center'>Nulla occaecat velit laborum exercitation ullamco. Elit labore eu aute elit nostrud culpa velit excepteur deserunt sunt. Velit non est cillum consequat cupidatat ex Lorem laboris labore aliqua ad duis eu laborum.</p>
            <ul className='text-[#000000] first-letter:font-montserrat text-[12px] font-medium m-4 leading-[21.66px] list-disc pl-5'>
             <li>Strowberry</li>
             <li>Cream</li>
             <li>wheat</li>
            </ul>
             <p className='text-[#000000] first-letter:font-montserrat text-[12px] font-medium m-4 leading-[21.66px] text-center'>Nulla occaecat velit laborum exercitation ullamco. Elit labore eu aute elit nostrud culpa velit excepteur deserunt sunt.</p>
           ...
           <button className='bg-[#B2AC88] fixed bottom-5 rounded-[22px] h-12 w-80 text-[#FEFEFF] font-montserrat text-base font-bold leading-4.5 tracking-wider'>Add To Cart</button>
           </div>
        </div>
      </div>
    </div>
