...
return (
  ...
  style={{ backgroundImage: "url('https://res.cloudinary.com/dnovcmruv/image/upload/v1715617620/Pattern_1_v6q46x.png')" }} >
       ...
       <button className=' absolute  w-[9.5rem] h-[3rem] min-b-[3rem] xs:top-[20rem]  top-[40rem] mt-[2rem] rounded-[15px] font-montserrat text-[16px] font-bold leading-[20.96px]  text-[#ffffff] bg-[#B2AC88]' onClick={CallVerifyPage}>Back</button>
  </div>
)
}
