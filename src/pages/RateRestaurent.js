        ...
        <div className='min-h-screen h-auto w-[100%] flex justify-center items-center  bg-cover  bg-[#FEFEFF]'
            style={{ backgroundImage: "url('https://res.cloudinary.com/dnovcmruv/image/upload/v1715617620/Pattern_1_v6q46x.png')", opacity:"15"}} >
              <div className='text-black flex flex-col items-center absolute'>
                 <img src='https://res.cloudinary.com/dnovcmruv/image/upload/v1716100702/Image_4_jwwy2w.png' alt='RestaurentImage' className='h-40 w-40 '/>
                 ...
                 <p className='w-50 h-3 text-[#3B3B3B] relative font-montserrat text-[14px] font-medium leading-[17.05px] tracking-[0.5px] text-center opacity-30 mt-12'>Please rate your Restaurant</p>
