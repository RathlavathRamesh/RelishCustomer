           ...
           <div className='h-[2rem] w-[2rem] bg-[#F2F1E6] top-[2.5rem] absolute left-[1.5rem] flex justify-center items-center rounded-[10px] '>
             ...
             This data will be displayed in your account profile for security
                ...
                <div className='flex'>
                    ...
                    <p className='text-[#09051C] w-28 h-[20px] absolute top-[16rem] left-[75px] 
                ...
                <input
                    type="text" className='w-96 h-[57px] left-32 text-[14px] font-rubik font-normal outline-none border-none leading-[16.59px] tracking-[0.5px] text-center text-black' placeholder='Set Location'/>
            </div>
