...
const SignIn = () => {
    ...
    return (
        ...
        style={{ backgroundImage: "url('https://res.cloudinary.com/dnovcmruv/image/upload/v1715617620/Pattern_1_v6q46x.png')" }}>
            ...
            <div  className="mt-[4rem] top-[22rem] flex flex-row justify-between  text-[#3B3B3B] h-[3rem] rounded-xl shadow-md p-4 w-[287px] left-[3rem]  w-42 h-17 absolute top-398 left-53  leading-[17.07px] tracking-[0.5px] text-left
              placeholder-[#3B3B3B]">
            ...
            <div  className="mt-[8rem] top-[22.5rem] flex flex-row justify-between  text-[#3B3B3B] h-[3rem] rounded-xl shadow-md p-4 w-[287px] left-[3rem]  w-42 h-17 absolute top-398 left-53  leading-[17.07px] tracking-[0.5px] text-left
              placeholder-[#3B3B3B]">
                <div className='flex flex-row items-center'>
                    <img src='https://res.cloudinary.com/dnovcmruv/image/upload/v1715702475/Profile_sbwfyj.png' className='h-[3vh] w-[5vw]'/>
            ...
            <div  className="mt-[12rem] top-[23rem] flex flex-row justify-between  text-[#3B3B3B] h-[3rem] rounded-xl shadow-md p-4 w-[287px] left-[3rem]  w-42 h-17 absolute top-398 left-53  leading-[17.07px] tracking-[0.5px] text-left
              placeholder-[#3B3B3B]">
                <div className='flex flex-row items-center'>
            ...
            <button className=' w-[9rem] h-[3rem]
                mt-[4rem] rounded-2xl font-montserrat text-[16px] font-bold leading-[20.96px]  text-[#ffffff] bg-[#B2AC88]' onClick={SignUpProcess} >Create Account</button>
            </div>
