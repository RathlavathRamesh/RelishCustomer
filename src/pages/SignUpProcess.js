    ...
    >
       <div className='h-[2rem] w-[2rem] bg-[#F2F1E6] top-[2.5rem] absolute left-[1.5rem] flex justify-center items-center rounded-[10px] '>
        ...
        <button className=' w-[9.5rem] h-[3rem] 
           rounded-tl-[15px]  rounded-bl-[15px] rounded-tr-[15px]  mt-[2rem] rounded-br-[15px] font-montserrat text-[16px] font-bold leading-[20.96px]  text-[#ffffff] bg-[#B2AC88]' onClick={callPaymentPage}>Next</button>
        </div>
    </div>
  )
}
